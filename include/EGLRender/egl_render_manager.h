...
namespace EGLRender
{
  ...
  struct EGLRenderManager
  {
    ...
    int create_surface( std::string_view name, std::string_view title, EGLRenderSurfaceClass surf_type=EGLRenderSurfaceClass::PBUFFER, EGLint w=1920, EGLint h=1080, EGLint colbits=8, EGLint alphabits=8, EGLint zbits=24 , EGLint stencilbits=8);
